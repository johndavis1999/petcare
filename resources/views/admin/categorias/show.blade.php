...
@section('contenido')
    <div class="d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a type="button" class="btn btn-warning" href="{{ url('/categorias') }}"><i class="fas fa-long-arrow-alt-left"></i> Volver</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-xl-6 mx-auto">
            ...
            <div class="card-body p-4">
                ...
                @endif
                <form class="row g-3 needs-validation" action="{{ url('categorias', $item) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="col-12">
