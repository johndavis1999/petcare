    ...
    <div class="row">
        <div class="col-xl-10 mx-auto">
            ...
            <div class="card-body p-4">
                ...
                @endif
                <form class="row g-3 needs-validation" action="{{ url('productos') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="descripcion" name="descripcion" cols="4" rows="2" placeholder="Descripción del producto" style="height: 150px;" value="{{ old('descripcion') }}"></textarea>
                            </div>
                            <div class="col-12">
