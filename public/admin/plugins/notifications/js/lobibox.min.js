...
!function() {
    ...
    var LobiboxBase = {
        ...
        _afterShow: function() {
            ...
            me.$options.draggable || $(window).on("resize.lobibox-" + me.$el.attr("data-nth"), function() {
                me.refreshWidth(),
                me.refreshHeight(),
        ...
        destroy: function() {
            ...
            me.$options.hideClass ? (me.$el.removeClass(me.$options.showClass).addClass(me.$options.hideClass),
            setTimeout(function() {
                callback()
            }, me.$options.delayToRemove)) : callback(),
            this
        ...
        show: function() {
            ...
            return me.$options.modal && ($body.addClass(Lobibox.base.OPTIONS.bodyClass),
            me._addBackdrop()),
    ...
    LobiboxPrompt.prototype = $.extend({}, LobiboxBase, {
        ...
        isValid: function() {
            ...
            return me.$options.required && !me.getValue() ? (me.$input.addClass("invalid"),
            0 === $error.length && (me.$el.find(".lobibox-body").append('<p class="lobibox-input-error-message">' + me.$options.errorMessage + "</p>"),
            me._position(),
            me.$input.focus()),
            !1) : (me.$input.removeClass("invalid"),
            $error.remove(),
            me._position(),
            me.$input.focus(),
            !0)
...
!function() {
    var LobiboxNotify = function(type, options) {
        ...
        var me = this
          , _processInput = function(options) {
            return ("mini" === options.size || "large" === options.size) && (options = $.extend({}, Lobibox.notify.OPTIONS[options.size], options)),
          ...
          , _createNotifyWrapper = function() {
            ...
            0 === $wrapper.length && ($wrapper = $("<div></div>").addClass(selector.replace(/\./g, " ").trim()).appendTo($("body")),
          ...
          , _createNotify = function() {
            var $iconEl, $innerIconEl, $iconWrapper, $body, $msg, OPTS = Lobibox.notify.OPTIONS, $notify = $("<div></div>", {
        ...
        me._init = function() {
            ...
            if ("mini" === me.$options.size && $notify.addClass("notify-mini"),
